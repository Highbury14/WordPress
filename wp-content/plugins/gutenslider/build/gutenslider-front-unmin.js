...
core_class.use([navigation, pagination, effect_coverflow, effect_cube, effect_fade, effect_flip, a11y, autoplay, lazy, keyboard, history_history, hash_navigation]);
...
class Gutenslider {
  ...
  initSwiper() {
    ...
    (_this$swiperInstance2 = this.swiperInstance) === null || _this$swiperInstance2 === void 0 ? void 0 : _this$swiperInstance2.destroy(true, true);
  ...
  onLgBeforeClose(e) {
    if (this.swiperSettings.autoplay) {
      setTimeout(() => {
        ...
        (_this$swiperInstance3 = this.swiperInstance) === null || _this$swiperInstance3 === void 0 ? void 0 : _this$swiperInstance3.autoplay.start();
      }, 1000);
    }
  }
  ...
  onLgAfterSlide(e) {
    ...
    if (typeof index !== 'undefined') {
      ...
      if (this.swiperSettings.loop) {
        ...
        (_this$swiperInstance4 = this.swiperInstance) === null || _this$swiperInstance4 === void 0 ? void 0 : _this$swiperInstance4.slideToLoop(parseInt(imageIndex));
      } else {
        var _this$swiperInstance5;

        (_this$swiperInstance5 = this.swiperInstance) === null || _this$swiperInstance5 === void 0 ? void 0 : _this$swiperInstance5.slideTo(parseInt(imageIndex));
      }
    }
